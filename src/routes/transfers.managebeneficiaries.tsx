...
const beneficiaries = [
  { initials: "RA", name: "Rahul Sharma", email: "rahul.sharma@example.com", acct: "XXXX XXXX 5678", bank: "HDFC Bank", ifsc: "HDFC0001234", ifscBank: "HDFC Bank Ltd", type: "Personal" },
  { initials: "SA", name: "Sunita Agarwal", email: "sunita.agarwal@example.com", acct: "XXXX XXXX 8901", bank: "ICICI Bank", ifsc: "ICIC0004321", ifscBank: "ICICI Bank Ltd", type: "Personal" },
  { initials: "VB", name: "Vijay Builders Pvt Ltd", email: "vijaybuilders@example.com", acct: "XXXX XXXX 3456", bank: "Axis Bank", ifsc: "UTIB0005678", ifscBank: "Axis Bank Ltd", type: "Business" },
  { initials: "NT", name: "Neha Tripathi", email: "neha.tripathi@example.com", acct: "XXXX XXXX 1122", bank: "State Bank of India", ifsc: "SBIN0007789", ifscBank: "State Bank of India", type: "Personal" },
];
          ...
          <div className="bg-card rounded-2xl border border-border shadow-sm p-5">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="flex items-center gap-1.5 px-4 py-2 text-sm bg-primary text-primary-foreground rounded-lg font-semibold hover:opacity-90"><Plus className="w-4 h-4" /> Add New Beneficiary</button>
              </div>
            </div>
